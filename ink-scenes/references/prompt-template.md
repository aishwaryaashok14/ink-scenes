...
Visual DNA:
Flat warm cream off-white background (unbleached paper tone, #F0E8DB), perfectly uniform — no texture, no gradient, no vignette. Fine dark sepia-black ink linework (#1C120B, near-black with a warm cast) with confident, even-weight contour lines, in the manner of classic pen-and-ink comics. Form, shadow, and texture rendered only through selective crosshatching and stippling — no soft shading, no gradients, no glossy highlights. Muted palette: warm grays and putty (#D4CEBF, #C1B39D) and cream for most surfaces, quiet low-saturation earth tones (sage-olive #858570, dusty amber #BC8A4D, maroon #773639) where the scene needs them, plus one accent hue — brick red to tomato-vermilion (#8B3C35 to #DF4E31) — with a single dominant carrier. Generous empty cream space. Minimal or no ground shadows. Warm, deadpan, quietly humorous editorial tone.
